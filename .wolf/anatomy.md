...
> Auto-maintained by OpenWolf. Last scanned: 2026-06-03T01:29:40.000Z
...
- `admin-cron-command.test.mjs` — dataRoot: resetCronTables, seedCronFixture, seedCronIssuesFixture, seedHealthyCronFixture; manual weekly retry closures (~10258 tok)
...
- `daemon-loop.test.mjs` — resetRuntimeTables: setClaudeBridgeEnv (~40310 tok)
