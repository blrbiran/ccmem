...
> 🆕🔴 **2026-08-20 新增 W0 —— 本节没有它，别把本节当穷举。**
> **W0 = 通用"非默认配置上报"机制**，由人类裁决从 W1/W2 的共同需求里抽出来独立成条。
> 设计与实现计划：`docs/superpowers/specs/2026-08-20-w0-non-default-config-reporting-design.md`
> 与 `docs/superpowers/plans/2026-08-20-w0-non-default-config-reporting.md`。
> ⇒ **W0 是 W1 判据 4 的前置件**，落地顺序 **W0 → W1 → W2 → W3**。
